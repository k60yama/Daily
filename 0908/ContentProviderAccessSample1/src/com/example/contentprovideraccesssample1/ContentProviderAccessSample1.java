...
public class ContentProviderAccessSample1 extends Activity implements OnClickListener{
	...
	public void onClick(View view) {
    	...
    	case R.id.registry:
    		...
    		break;
    	case R.id.update:
    		msg = this.dataUpdate(values);
    		break;
    	case R.id.delete:
    		msg = this.dataDelete(values);
    		break;
    	case R.id.view:
    ...
    public String dataUpdate(EditText[] value){
    	try{
    		...
    		if(value[0] != null && !(value[0].equals(""))){
    			condition = "productid ='" + value[0].getText().toString() + "'";
    		}
    		...
    		//データ更新
    		this.getContentResolver().update(uri, val, condition, null);
    ...
    public String dataDelete(EditText[] value){
    	try{
    		...
    		//データ削除
    		this.getContentResolver().delete(uri, condition, null);
